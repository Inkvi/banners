...
//      ),
      ...
      array('allow', // allow demo user to perform 'admin' and 'delete' actions
  ...
  public function actionCreate()
  {
    ...
    if (isset($_POST['Banner']))
    {
      ...
      if ($model->save())
      {
        $uploadedFile->saveAs(Yii::app()->basePath . Yii::app()->params['bannersDir'] . $fileName);
  ...
  public function actionUpdate($id)
  {
    ...
    if (isset($_POST['Banner']))
    {
      ...
      if ($model->save())
      {
        ...
        {
          $uploadedFile->saveAs(Yii::app()->basePath . Yii::app()->params['bannersDir'] . $model->image);
        }
        $this->redirect(array('view', 'id' => $model->id));
      }
    }
